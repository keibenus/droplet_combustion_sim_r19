...
# --- Output Options ---
OUTPUT_DIR = 'results_r19_r02_DNS_case3_C_0p1' # Changed output dir name
SAVE_INTERVAL_DT = 1e-5 # s (新しい方法: 保存したい時間間隔を指定、例: 1e-5 = 0.01 ms)

# --- Initial Conditions ---
T_INF_INIT = 350.0  # K (Initial ambient gas temperature)
P_INIT = 1.0e6     # Pa (Initial pressure)
...
TURBULENCE_CONSTANT_PARAMS = {
    'k': 0.2774, #0.0726, #0.2774,      # [m^2/s^2] 乱流エネルギー
    'epsilon': 126.3 #17.3 #126.3 # [m^2/s^3] 乱流散逸率
}
...
CORRECT_STAG_NU = 1.0 #0.25
CORRECT_STAG_SH = 1.0 #0.25
CORRECT_TURB_NU = 1.0 #0.4
CORRECT_TURB_SH = 1.0 #0.4

RELATIVE_DROPLET_VELOCITY = 0.0
VISC_SUBLAYER_FACTOR = 5.0
C_MUT_DAMP_FACTOR = 0.1
